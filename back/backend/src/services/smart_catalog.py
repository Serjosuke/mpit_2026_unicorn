...
def _course_row(course: Course, query: str, normalized: dict) -> dict:
    ...
    return {
        ...
        "difficulty": course.level if course.level in ["easy", "medium", "hard"] else None,
        "average_rating": None,
        "ai_rating": 4.9 if course.course_type == "internal" else 4.6 if course.is_featured_internal else None,
        "ai_review": why,
        "score": round(score, 4),
        "why_recommended": why,
        "course_id": course.id,
